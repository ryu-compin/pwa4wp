...
$cacheSettings    = $data['advancedSettings'];
...
<h2><?php _e("Advanced Configulations","pwa4wp"); ?></h2>
    ...
    ?>
<form enctype="multipart/form-data" id="pwa4wp-advanced-setting-form" method="post" action="">
    <ul>
        <li>
            <label>
                <span class="itemname">
    ...
    <span class="submit_button_area">
        <button type="submit" class="submit_button">Save advanced configurations</button>
    </span>
    <hr>
    </form>
</div>
